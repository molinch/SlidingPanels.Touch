...
namespace SlidingPanels.Lib.TransitionLogic
{
	...
	public abstract class PanelContainerTransitionLogic
	{
		...
		public abstract void ResizeContainer (PanelContainer container, CGSize screenSize);

		public abstract void RotateContainer(PanelContainer container, CGSize screenSize);
	}
}
